...
global ds;
ds.params = struct(..., 
  'experiment_name', 'test',...%<-- NAME OF THE EXPERIMENT: IMPORTANT to differenciate experimental saved results
  ...
  'pos_sample_size', 5, ... % initial sample size % usually 2000 positive images is enough; sometimes even 1000 works
  'neg_sample_size', 5, ... % initial sample size % usually 2000 positive images is enough; sometimes even 1000 works   
  'seed_candidate_size', 3, ... %  ratio from the sample to get the number of images used to get seed patches candidates 
