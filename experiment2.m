...
% EXPERIMENT 2
% Discovering discriminative + frequent visual elements from contemporary buildings
...
global ds;
ds.params = struct(..., 
  'experiment_name', 'exp2',...%<-- NAME OF THE EXPERIMENT: IMPORTANT to differenciate experimental saved results
  ...
  'pos_sample_size', 100, ... % sample size for positive images % usually 2000 positive images is enough; sometimes even 1000 works
  'neg_sample_size', 400, ... % sample size for negative images % usually 2000 positive images is enough; sometimes even 1000 works   
