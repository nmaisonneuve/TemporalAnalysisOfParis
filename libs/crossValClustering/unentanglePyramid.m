function [features, levels, indexes, gradsums] = unentanglePyramid(pyramid,params)
...
% Author: saurabh.me@gmail.com (Saurabh Singh).
  ...
  % generate empty cell of size = pyramid.features (x 19 = number of scale)
  ...
  for i = 1 : length(pyramid.features)
    [feats, indexes, selGradsums{i,1}] = getFeaturesForLevel(pyramid.features{i}, prSize, ...
